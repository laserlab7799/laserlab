...
def main():
    ...
    if stats_mismatch:
        print(f"[warn] stats/stats2 FIPS mismatch for state={args.state}; forcing penalty_pts=100")
    ...
    for ts in targets:
        ...
        # NEW: hard override if stats vs stats2 aren't aligned on FIPS
        penalty_pts = 100.0 if stats_mismatch else (percent_nd / 0.5)
