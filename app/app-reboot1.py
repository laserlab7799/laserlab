#!/usr/bin/env python3
"""
app-rebooter1.py — PRIMARY watchdog for app_hub (9051) + peer babysitter (rebooter2).
- Exposes its own /health on port 9050
- Checks peer /health on port 9049 and restarts rebooter2 if it's down
...
R1_HEALTH_PORT = int(os.getenv("R1_HEALTH_PORT", "9050"))
R2_HEALTH_URL  = os.getenv("R2_HEALTH_URL", "http://127.0.0.1:9049/health")
...
def hub_health_ok() -> bool:
    ...
    return code == 200 or code == 204  # treat 200/204 as ok
