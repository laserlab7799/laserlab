...
FULL_DATA_URLS = [
    #os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T02:35:22.000Z")),
    #os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T03:35:22.000Z")),
    #os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T04:35:22.000Z")),
    #os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T05:35:22.000Z")),
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=PA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T01:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T06:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=PA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T02:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T12:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=PA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T03:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-07T02:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=PA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T04:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-12T02:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=PA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T05:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-20T02:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=PA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T06:35:22.000Z")),
    
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-25T02:35:22.000Z")),
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-29T02:35:22.000Z")),
    os.getenv("FULL_DATA_URL_1", os.getenv("FULL_DATA_URL", "https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=CA&level=ru&raceTypeID=G&historyDateTime=2024-11-30T02:35:22.000Z")),
]


_full_rot_idx = 0  # runtime rotation pointer
CURRENT_FULL_DATA_URL = FULL_DATA_URLS[0]  # what _fetch_full_once() uses



#FULL_DATA_URL = os.getenv(
#    "FULL_DATA_URL",
#    f"https://api.ap.org/v3/elections/2024-11-05?testID=20241105&statepostal=PA&level=ru&raceTypeID=G&historyDateTime=2024-11-06T04:35:22.000Z"
...
def _export_stats_once(*, office, usps, district):
    ...
    _atomic_write_text(os.path.join(out_dir, "stats.csv"), "\n".join(lines) + "\n")
...
def _kick_pipeline_after_export(*, office, usps, district):
    """Run pipeline per-target (parallel-safe)."""
    ...
    with lock:
        info = _pipeline_procs.get(key)
        if info is not None and info["proc"].poll() is None:
            # already running for this exact target
            return

        log(f"Pipeline started: {' '.join(cmd)} (cwd={target_dir})")
    ...
    # ---- wait in a background thread, then convert ----
    def _wait_and_convert():
        try:
            rc = p.wait()

            # ---- capture finished pipeline stats ----
            key = f"{office}:{usps}:{district or ''}"
            ...
            log(f"Pipeline finished rc={rc}, running convert_plotdata_folder.py…")
            ...
            log(f"convert_plotdata_folder.py completed for {target_dir}")

        except Exception as e:
            log(f"Pipeline/convert failed for {target_dir}: {e}", "WARN")

    threading.Thread(target=_wait_and_convert, daemon=True).start()
...
def _stats_export_loop():
    ...
    TARGETS = parse_targets("H:CA:13,H:CA:1,P:PA,S:PA")

    # Fallback (probably no longer needed, but safe)
    if not TARGETS:
        TARGETS = [{
            "office": STATS_EXPORT_OFFICE,
    ...
    log(f"Stats export loop enabled: {len(TARGETS)} target(s) every {interval}s")
        ...
        try:
            ...
            if _hub_cfg["mode"] == "general":
                ...
                if not all_dates:
                    ...
                    sleep_s = 40.0  # one date every ~20s
                ...
                sleep_s = 40.0  # main, main, secondary → 3 hits per min
